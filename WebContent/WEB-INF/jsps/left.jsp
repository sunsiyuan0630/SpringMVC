...
<body>
        ...
        <div class="c3" style="top: 0px; padding-top: 0px;height:100%;width:100%;">
          <ul class="nav nav-sidebar">
          	<li class="active"><a href="${pageContext.request.contextPath}/struts/storage" target="view_frame">入库</a></li>
            <li><a href="${pageContext.request.contextPath}/struts/storage" target="view_frame">出库/销售</a></li>
            <li><a href="${pageContext.request.contextPath}/struts/storage" target="view_frame">查看库存</a></li>
